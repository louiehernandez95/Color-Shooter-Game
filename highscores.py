...
class HighScores(state.State):
    ...
    def __init__(self, score):
        ...
        self.Try_manager = pygame.font.SysFont("comicssansms", 38)
        self.Try_Again=self.Try_manager.render("PRESS THE SPACEBAR TO TRY AGAIN", True, (255,255,255))
        self.Try_Again2 = self.Try_manager.render("PRESS 'ENTER' TO RETURN TO THE MAIN MENU", True, (255, 255, 255))
        self.Try_Again_rect = pygame.Rect((self.display.get_width() / 2 - self.Try_Again.get_width() / 2,450),
                                        (self.Try_Again.get_width(), self.Try_Again.get_height()))
        self.Try_Again_rect2 = pygame.Rect((self.display.get_width() / 2 - self.Try_Again2.get_width() / 2, 500),
                                          (self.Try_Again2.get_width(), self.Try_Again2.get_height()))
    ...
    def act(self):
        ...
        self.display.blit(self.Try_Again2, self.Try_Again_rect2)
